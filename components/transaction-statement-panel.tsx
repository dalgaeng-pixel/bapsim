...
function printTransactionStatement(statement: TransactionStatement, supplier: SupplierProfile) {
  ...
  documentRef.write([
    ...
    "table{width:100%;border-collapse:collapse;table-layout:fixed}th,td{height:4.15mm;border-right:1px solid #111;border-bottom:1px solid #111;padding:0 .8mm;text-align:center;white-space:nowrap}th{height:5mm;background:#f5f5f5;font-weight:800}th:nth-child(1){width:18%}th:nth-child(2),th:nth-child(3){width:14%}th:nth-child(4){width:18%}th:nth-child(5){width:36%}td:nth-child(4){text-align:right}td:nth-child(5){text-align:left;white-space:normal;overflow-wrap:anywhere;word-break:break-word;line-height:1.2;padding-top:.5mm;padding-bottom:.5mm}.locations.one td{height:6.1mm}.locations.two td{height:4.4mm}.blank td{color:transparent}",
